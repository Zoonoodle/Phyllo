...
struct NutriSyncCard<Content: View>: View {
...
struct SimpleNutriSyncCard<Content: View>: View {
    let content: () -> Content
...
#Preview {
    ZStack {
        ...
        VStack(spacing: 16) {
            NutriSyncCard(title: "Daily Nutrition", subtitle: "0% Complete • 0 windows remaining") {
                Text("Card content")
                    .foregroundColor(.white)
            }
