//
//  NutriSyncScoreMini.swift
//  NutriSync
//
//  Created on 2/2/25.
//
//  Compact NutriSyncScore display for story chapters

import SwiftUI

struct NutriSyncScoreMini: View {
    let score: Int
...
struct NutriSyncScoreComparison: View {
    let startScore: Int
        ...
        VStack(spacing: 16) {
            HStack(spacing: 24) {
                ...
                VStack(spacing: 8) {
                    ...
                    NutriSyncScoreMini(score: startScore, showLabel: false)
                ...
                VStack(spacing: 8) {
                    ...
                    NutriSyncScoreMini(score: currentScore, showLabel: false)
...
#Preview("NutriSyncScoreMini") {
    ZStack {
        Color.nutriSyncBackground.ignoresSafeArea()
        
        VStack(spacing: 32) {
            NutriSyncScoreMini(score: 42)
            
            NutriSyncScoreMini(score: 75, trend: .improving)
            
            NutriSyncScoreMini(score: 85, trend: .stable, showLabel: false)
            
            NutriSyncScoreComparison(startScore: 42, currentScore: 75, daysElapsed: 7)
        }
        .padding()
    }
}