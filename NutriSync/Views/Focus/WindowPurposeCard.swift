    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                if !window.foodSuggestions.isEmpty {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ForEach(window.foodSuggestions, id: \.self) { food in
                ...
                if !window.micronutrientFocus.isEmpty {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack(spacing: 8) {
                            ForEach(window.micronutrientFocus, id: \.self) { nutrient in
