        ...
        VStack(spacing: 16) {
            ...
            if notificationManager.authorizationStatus == .provisional {
                ...
                if notificationManager.authorizationStatus == .denied {
                    ...
                    Text("To enable notifications, go to Settings > Notifications > NutriSync and turn on Allow Notifications.")
                        .font(.caption)
                        .foregroundColor(.white.opacity(0.6))
                        .multilineTextAlignment(.center)
                        .padding(.horizontal)
    ...
    private func requestPermission() {
        ...
        Task {
            ...
            if granted {
                ...
                if notificationManager.authorizationStatus == .denied {
                    alertMessage = "Notifications have been disabled. To enable them, please go to Settings > Notifications > NutriSync."
                    showingAlert = true
                }
            }
        }
