...
struct MFEatingWindowView: View {
...
struct EatingWindowCard: View {
    let window: MFEatingWindowView.EatingWindow
    let isSelected: Bool
    let onTap: () -> Void
...
struct CircadianTimelineView: View {
    let selectedWindow: MFEatingWindowView.EatingWindow?
    ...
    private func windowWidth(for window: MFEatingWindowView.EatingWindow, in totalWidth: CGFloat) -> CGFloat {
        // 8 hours of 16 hour awake display
        return totalWidth * (8.0 / 16.0)
    }
    
    private func windowOffset(for window: MFEatingWindowView.EatingWindow, in totalWidth: CGFloat) -> CGFloat {
    ...
    private func windowDescription(for window: MFEatingWindowView.EatingWindow) -> String {
        switch window {
        case .earlyBird:
