//
//  MFOnboardingSectionData.swift
//  NutriSync
//
//  Section structure and flow for MacroFactor-style onboarding
//

import SwiftUI

// MARK: - Section Type
enum MFOnboardingSection: String, CaseIterable {
    case basics = "Basics"
    case notice = "Notice"
    ...
    var description: String {
        switch self {
        case .basics:
            return "NutriSync's calorie targets are based on estimates of your daily energy expenditure. We will fine-tune those estimates over time. For now, we need some basic information to calculate your starting point."
        case .notice:
...
struct MFOnboardingFlow {
    static let sections: [MFOnboardingSection: [String]] = [
        ...
        .program: [
            ...
            // New meal timing screens will go here
            "Sleep Schedule",
            "Meal Frequency",
            "Breakfast Habit",
            "Eating Window"
    ...
    static func screens(for section: MFOnboardingSection) -> [String] {
        sections[section] ?? []
    }
    
    static func section(for screenName: String) -> MFOnboardingSection? {
